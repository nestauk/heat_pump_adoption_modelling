...
def load_domestic_hps():
    hps = (
        pd.read_excel(PROJECT_DIR / "inputs/NESTA data files/Heat pump installations 2010 to 31082021.xlsx",
        dtype = {
            "Address Line 1": str,
            "Address Line 2": str,
            "Address Line 3": str,
    ...
    for key, value in regex_dict.items():
        dhps[key] = [
            re.search(value, product).group(1).strip()
            for product
            in dhps.products
        ]
...
# 69328 domestic HP installations
